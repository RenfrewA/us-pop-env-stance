...
cleaned_ces2020_env <-
  cleaned_ces2020_env |>
  filter(!is.na(CC20_333b), ideo5 != 6, faminc_new != 97, urbancity != 5) # Filter out people who didn't answer the env question, ideo5 6: Not sure, faminc_new: 97 prefer not to say, urbancity: 5 other
